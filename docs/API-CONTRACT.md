...
> (`tujuan_branch_id` terisi) **hanya** bisa diselesaikan di sini —
> `POST /api/{mod}/konfirmasi/:fakturId` menolaknya dengan **409**. Pengirim
> tidak boleh menuntaskan kirimannya sendiri; harus ada orang di cabang tujuan
> yang menekan Terima, dan stok baru bertambah setelah itu.
