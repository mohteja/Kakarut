...
import type { FakturGroup, StokMasukRow } from "../pages/produksi/TambahStokPage";
 ...
 * printernya dipindah, atau footer strukk diubah, seseorang menjual sesuatu
...
export function contohStruk(opts: {
  branchId: string;
  branchNama: string;
  kasir?: string | null;
